...
//        return entityManager.find(Course.class, id); --> Because @Lazy on Review, do not retrieve review.
//Following code request review so it retrieve course and it's reviews.
        TypedQuery<Course> query = entityManager.createQuery(
